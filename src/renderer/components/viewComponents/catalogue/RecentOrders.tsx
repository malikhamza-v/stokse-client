...
function RecentOrders() {
  ...
  const { loading: orderLoading, fetchData: ordersFetch } = useFetch();
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-x-3">
            <h2 className="text-gray-800 font-bold text-2xl">Recent Orders</h2>

            <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full  ">
              {orders.results?.length} orders
            </span>
          </div>

          <p className="mt-1 text-sm text-gray-500 ">
            These are the recent orders of your store.
          </p>
        </div>
      </div>
                            ...
                            <td className="py-4 pl-4 pr-8 text-sm w-[20%]">
                              <div>
                                <h4 className="text-gray-700 ">
                                  <span>
                                    {order.items.length} products sold
                                  </span>
                                </h4>
                              </div>
                            </td>
